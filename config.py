...
FORCESUB_CHANNEL = int(os.environ.get("FORCESUB_CHANNEL", "-1001984413278"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002118741689"))
FORCESUB_CHANNEL3 = int(os.environ.get("FORCESUB_CHANNEL3", "-1002020472953"))
...
TUT_VID = os.environ.get("TUT_VID","open_my_linkz")
